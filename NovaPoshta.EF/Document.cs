...
namespace NovaPoshta.EF
{
    public class Document
    {
        ...
        public Guid? Fk_CitySenderGuid { get; set; }
        [ForeignKey("Fk_CitySenderGuid")]
        public City CitySender { get; set; }
        public Guid? Fk_CityRecipientGuid { get; set; }
        [ForeignKey("Fk_CityRecipientGuid")]
        public City CityRecipient { get; set; }
